...
// 7X Crush provider wallet callback API
// Final URLs:
// POST /api/provider-wallet/wallet/balance
// POST /api/provider-wallet/wallet/debit
// POST /api/provider-wallet/wallet/credit
// POST /api/provider-wallet/wallet/rollback
app.use('/api/provider-wallet', providerWalletRoutes);
