...
export const env = {
  ...
  CRYPTO_WITHDRAW_ALLOWED_METHODS: process.env.CRYPTO_WITHDRAW_ALLOWED_METHODS || 'BNB,USDT_BEP20,USDT_TRC20,ETH,USDT_ERC20',
  ...
  CRYPTO_WITHDRAW_BSC_GAS_LIMIT: process.env.CRYPTO_WITHDRAW_BSC_GAS_LIMIT || '30000',
