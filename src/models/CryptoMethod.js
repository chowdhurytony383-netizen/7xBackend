...
const cryptoMethodSchema = new mongoose.Schema({
  ...
  withdrawEnabled: { type: Boolean, default: true, index: true },
  minWithdrawFiat: { type: Number, default: 100 },
  maxWithdrawFiat: { type: Number, default: 25000 },
  withdrawWarning: { type: String, default: '' },
